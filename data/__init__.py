...
class CustomDatasetDataLoader():
    ...
    def __init__(self, opt, phase):
        ...
        self.dataloader = torch.utils.data.DataLoader(
            ...
            # FIXME: N_rand is ray batch not image batch?
            # batch_size=opt.N_rand,
            batch_size=1,
    ...
    def __iter__(self):
        ...
        for i, data in enumerate(self.dataloader):
            ...
            # if i * self.opt.N_rand >= self.opt.max_dataset_size:
            if i * 1 >= self.max_dataset_size:
                break
            yield data
    
    def get_misc(self):
        return self.dataset.get_misc()

    def get_render_poses(self):
        return self.dataset.get_render_poses()

    def get_poses(self):
        return self.dataset.get_poses()